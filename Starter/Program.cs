        ...
        public static void MakeScript(string port)
        {
            ...
            try
            {
                ...
                script += "\n#Build and publish\n" +
                        ...
                        "rm -r ~/Distributed/UniprotDistributed/UniprotDistributedSlave/bin/Debug/netcoreapp2.0/slaves; mkdir ~/Distributed/UniprotDistributed/UniprotDistributedSlave/bin/Debug/netcoreapp2.0/slaves/; echo tijan99 | sudo chmod -R a+rwx ~/Distributed/UniprotDistributed/UniprotDistributedSlave/bin/Debug/netcoreapp2.0/slaves/\n";
